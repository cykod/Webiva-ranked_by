...
class AmazonProductWebService < RESTHome
  ...
  namespace '/onca' do
    route :item_search, '/xml', :query => {'Keywords' => :arg1, 'SearchIndex' => :arg2, 'Operation' => 'ItemSearch', 'Service' => 'AWSECommerceService', 'ResponseGroup' => 'Medium'} do |res|
      res['ItemSearchResponse']['Items']['Item']
    end

    route :item_lookup, '/xml', :query => {'ItemId' => :arg1, 'Operation' => 'ItemLookup', 'Service' => 'AWSECommerceService', 'ResponseGroup' => 'Medium'} do |res|
